                        ...
                        <table border="0" class="profile-container">
                            <tr>
                                ...
                                <td style="padding:0px;margin:0px;">
                                    ...
                                    <p class="profile-subtitle">admin@LiveDoc.com</p>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="2">
        ...
        if($action=='drop'){
            ...
            <div id="popup1" class="overlay">
                    ...
                    <center>
                        ...
                        <a class="close" href="doctors.php">&times;</a>
                        <div class="content">
                            LiveDoc Hospital Appointment APP<br>
            ...
            if($error_1!='4'){
                    ...
                    <div id="popup1" class="overlay">
                            ...
                            <center>
                                ...
                                <div style="display: flex;justify-content: center;">
                                <div class="abc">
                                <table height= " 100%" width="80%" class="sub-table scrolldown add-doc-form-container" border="0">
                                <tr>
                                        <td class="label-td" colspan="2">'.
                                            $errorlist[$error_1]
                                        .'</td>
